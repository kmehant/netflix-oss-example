...
```
docker run -p 9092:9092 -d --name service-b -e "spring.profiles.active=docker" -e "server.port=9092" --add-host eureka-server-docker:<eureka server ip>  --add-host configservice:<config service ip> service-b
```
